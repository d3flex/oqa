...
- Emacs 28.1 or newer.  Emacs 29.1 specifically has an upstream
  =package.el= bug that breaks upgrading the built-in =seq= (a =transient=
  dependency) with "Cannot open load file: seq-25"; use 29.2 or newer.
